...
@MethodHandler
public class BukkitGetWhitelistedPlayers implements IMethod
{
    @Override
    public Object execute(final ICore instance, final Object... inputs) {
        final Set<OfflinePlayer> wlp = (Set<OfflinePlayer>)((Server)instance.getGameServer()).getWhitelistedPlayers();
